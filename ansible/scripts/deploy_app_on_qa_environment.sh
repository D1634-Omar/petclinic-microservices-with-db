...
<<<<<<< HEAD
AWS_REGION=$AWS_REGION helm repo add stable-petclinic s3://petclinic-helm-charts-oparlak/stablemyapp/ || echo "repository name already exists"
=======
AWS_REGION=$AWS_REGION helm repo add stable-petclinic s3://petclinic-helm-charts-oparlak/stable/myapp/ || echo "repository name already exists"
>>>>>>> feature/msp-20
